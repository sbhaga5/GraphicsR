...
#rgb1 <- col2rgb(pallette_reason$Yellow)/255
...
debtPlot <- function(data) {
  ...
  ggplot2::ggplot(graph,
    ...
    ggplot2::geom_line(ggplot2::aes(y = graph$funded_ratio * (y_maximum)),
                       color = pallette_reason$GreyBlue,#Referenced Color Palette
    ...
    ggplot2::scale_fill_manual(
      values = c("negative" = paste(pallette_reason$Green),#Referenced Color Palette
                 "positive" = paste(pallette_reason$Red)),#Referenced Color Palette
